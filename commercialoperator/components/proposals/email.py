...
class QAOfficerSendNotificationEmail(TemplateEmailBase):
    ...
    html_template = (
        "commercialoperator/emails/proposals/send_qaofficer_notification.html"
    )
...
class QAOfficerCompleteNotificationEmail(TemplateEmailBase):
    ...
    html_template = (
        "commercialoperator/emails/proposals/send_qaofficer_complete_notification.html"
    )
    txt_template = (
        "commercialoperator/emails/proposals/send_qaofficer_complete_notification.txt"
    )
...
class ReferralSendNotificationEmail(TemplateEmailBase):
    ...
    html_template = (
        "commercialoperator/emails/proposals/send_referral_notification.html"
    )
...
class ReferralFilmingSendNotificationEmail(TemplateEmailBase):
    subject = (
        "A referral for a commercial filming licence application has been sent to you."
    )
    html_template = (
        "commercialoperator/emails/proposals/send_filming_referral_notification.html"
    )
    txt_template = (
        "commercialoperator/emails/proposals/send_filming_referral_notification.txt"
    )
...
class ReferralCompleteNotificationEmail(TemplateEmailBase):
    ...
    html_template = (
        "commercialoperator/emails/proposals/send_referral_complete_notification.html"
    )
    txt_template = (
        "commercialoperator/emails/proposals/send_referral_complete_notification.txt"
    )
...
class ProposalApprovalSendNotificationEmail(TemplateEmailBase):
    ...
    html_template = (
        "commercialoperator/emails/proposals/send_approval_notification.html"
    )
...
class ProposalFilmingApprovalSendNotificationEmail(TemplateEmailBase):
    subject = "{} - Commercial Operations Licence Approved.".format(settings.DEP_NAME)
    html_template = (
        "commercialoperator/emails/proposals/send_filming_approval_notification.html"
    )
    txt_template = (
        "commercialoperator/emails/proposals/send_filming_approval_notification.txt"
    )
...
class ProposalEventApprovalSendNotificationEmail(TemplateEmailBase):
    subject = "{} - Commercial Operations Licence Approved.".format(settings.DEP_NAME)
    html_template = (
        "commercialoperator/emails/proposals/send_event_approval_notification.html"
    )
    txt_template = (
        "commercialoperator/emails/proposals/send_event_approval_notification.txt"
    )


class ProposalAwaitingPaymentApprovalSendNotificationEmail(TemplateEmailBase):
    subject = "{} - Commercial Filming Application - Pending Payment.".format(
        settings.DEP_NAME
    )
...
class AmendmentRequestSendNotificationEmail(TemplateEmailBase):
    subject = "{} - Commercial Operations Incomplete application.".format(
        settings.DEP_NAME
    )
    html_template = (
        "commercialoperator/emails/proposals/send_amendment_notification.html"
    )
...
class FilmingAmendmentRequestSendNotificationEmail(TemplateEmailBase):
    subject = "{} - Commercial Filming Incomplete application.".format(
        settings.DEP_NAME
    )
    html_template = (
        "commercialoperator/emails/proposals/send_amendment_notification.html"
...
class ExternalSubmitSendNotificationEmail(TemplateEmailBase):
    ...
    html_template = (
        "commercialoperator/emails/proposals/send_external_submit_notification.html"
    )
    txt_template = (
        "commercialoperator/emails/proposals/send_external_submit_notification.txt"
    )
...
class ApproverDeclineSendNotificationEmail(TemplateEmailBase):
    ...
    html_template = (
        "commercialoperator/emails/proposals/send_approver_decline_notification.html"
    )
    txt_template = (
        "commercialoperator/emails/proposals/send_approver_decline_notification.txt"
    )
...
class ApproverApproveSendNotificationEmail(TemplateEmailBase):
    ...
    html_template = (
        "commercialoperator/emails/proposals/send_approver_approve_notification.html"
    )
    txt_template = (
        "commercialoperator/emails/proposals/send_approver_approve_notification.txt"
    )
...
class ApproverSendBackNotificationEmail(TemplateEmailBase):
    ...
    html_template = (
        "commercialoperator/emails/proposals/send_approver_sendback_notification.html"
    )
    txt_template = (
        "commercialoperator/emails/proposals/send_approver_sendback_notification.txt"
    )
...
class DistrictProposalDeclineSendNotificationEmail(TemplateEmailBase):
    subject = "Your Application has been declined."
    html_template = (
        "commercialoperator/emails/proposals/send_district_decline_notification.html"
    )
    txt_template = (
        "commercialoperator/emails/proposals/send_district_decline_notification.txt"
    )


class DistrictProposalApprovalSendNotificationEmail(TemplateEmailBase):
    subject = "{} - Commercial Filming Lawful Authority Approved.".format(
        settings.DEP_NAME
    )
    html_template = (
        "commercialoperator/emails/proposals/send_district_approval_notification.html"
    )
    # html_template = 'commercialoperator/emails/proposals/send_district_decline_notification.html'
    txt_template = (
        "commercialoperator/emails/proposals/send_district_approval_notification.txt"
    )
...
def send_referral_email_notification(referral, recipients, request, reminder=False):
    ...
    if referral.proposal.org_applicant:
        ...
        _log_user_email(
            msg, referral.proposal.submitter, referral.referral, sender=sender
        )
...
def send_proposal_approval_email_notification(proposal, request):
    ...
    msg = email.send(
        proposal.proposal_submitter_email,
        bcc=all_ccs,
...
def send_district_proposal_submit_email_notification(district_proposal, request):
    ...
    url = request.build_absolute_uri(
        reverse(
            "internal-district-proposal-detail",
            kwargs={
                "proposal_pk": proposal.id,
                "district_proposal_pk": district_proposal.id,
            },
        )
    )
    if "-internal" not in url:
...
def send_district_proposal_approver_sendback_email_notification(
    request, district_proposal
):
    proposal = district_proposal.proposal
...
# send email when Proposal is 'proposed to decline' by assessor.
def send_district_approver_decline_email_notification(
    reason, request, district_proposal
):
    proposal = district_proposal.proposal
...
def send_district_proposal_decline_email_notification(
    district_proposal, request, proposal_decline
):
    email = DistrictProposalDeclineSendNotificationEmail()
    proposal = district_proposal.proposal

    context = {"proposal": proposal, "district_proposal": district_proposal}
    cc_list = proposal_decline.cc_email
    all_ccs = []
    if cc_list:
        all_ccs = cc_list.split(",")
...
def send_district_proposal_approval_email_notification(
    district_proposal,
    approval,
    request,
):
...
def send_district_proposal_approval_email_notification_orig(
    district_proposal, approval, request
):
