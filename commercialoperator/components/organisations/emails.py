...
class OrganisationRequestAcceptNotificationEmail(TemplateEmailBase):
    ...
    html_template = (
        "commercialoperator/emails/organisation_request_accept_notification.html"
    )
    txt_template = (
        "commercialoperator/emails/organisation_request_accept_notification.txt"
    )
...
class OrganisationAccessGroupRequestAcceptNotificationEmail(TemplateEmailBase):
    ...
    html_template = (
        "commercialoperator/emails/org_access_group_request_accept_notification.html"
    )
    txt_template = (
        "commercialoperator/emails/org_access_group_request_accept_notification.txt"
    )
...
class OrganisationRequestDeclineNotificationEmail(TemplateEmailBase):
    ...
    html_template = (
        "commercialoperator/emails/organisation_request_decline_notification.html"
    )
    txt_template = (
        "commercialoperator/emails/organisation_request_decline_notification.txt"
    )
...
class OrganisationContactAdminUserNotificationEmail(TemplateEmailBase):
    ...
    html_template = (
        "commercialoperator/emails/organisation_contact_admin_notification.html"
    )
    txt_template = (
        "commercialoperator/emails/organisation_contact_admin_notification.txt"
    )
...
class OrganisationContactUserNotificationEmail(TemplateEmailBase):
    ...
    html_template = (
        "commercialoperator/emails/organisation_contact_user_notification.html"
    )
    txt_template = (
        "commercialoperator/emails/organisation_contact_user_notification.txt"
    )
...
class OrganisationContactSuspendNotificationEmail(TemplateEmailBase):
    ...
    html_template = (
        "commercialoperator/emails/organisation_contact_suspend_notification.html"
    )
    txt_template = (
        "commercialoperator/emails/organisation_contact_suspend_notification.txt"
    )
...
class OrganisationContactReinstateNotificationEmail(TemplateEmailBase):
    ...
    html_template = (
        "commercialoperator/emails/organisation_contact_reinstate_notification.html"
    )
    txt_template = (
        "commercialoperator/emails/organisation_contact_reinstate_notification.txt"
    )
...
class OrganisationContactDeclineNotificationEmail(TemplateEmailBase):
    ...
    html_template = (
        "commercialoperator/emails/organisation_contact_decline_notification.html"
    )
    txt_template = (
        "commercialoperator/emails/organisation_contact_decline_notification.txt"
    )
...
class OrganisationAddressUpdatedNotificationEmail(TemplateEmailBase):
    ...
    html_template = (
        "commercialoperator/emails/organisation_address_updated_notification.html"
    )
    txt_template = (
        "commercialoperator/emails/organisation_address_updated_notification.txt"
    )
...
class OrganisationRequestLinkNotificationEmail(TemplateEmailBase):
    ...
    html_template = (
        "commercialoperator/emails/organisation_request_link_notification.html"
    )
    txt_template = (
        "commercialoperator/emails/organisation_request_link_notification.txt"
    )
