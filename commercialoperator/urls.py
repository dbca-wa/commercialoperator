...
router.register(r'proposal_submit',proposal_api.ProposalSubmitViewSet,"proposal_submit")
router.register(r'proposal_paginated',proposal_api.ProposalPaginatedViewSet,"proposal_paginated")
router.register(r'approval_paginated',approval_api.ApprovalPaginatedViewSet,"approval_paginated")
router.register(r'booking_paginated',booking_api.BookingPaginatedViewSet,"booking_paginated")
router.register(r'parkbooking_paginated',booking_api.ParkBookingPaginatedViewSet,"parkbooking_paginated")
...
router.register(r'overdue_invoices',booking_api.OverdueBookingInvoiceViewSet,"overdue_invoices")
...
router.register(r'marine_activities', main_api.MarineActivitiesViewSet,"marine_activities")
...
#Events
router.register(r'proposal_events_parks', proposal_api_event.ProposalEventsParksViewSet,"proposal_events_parks")
router.register(r'abseiling_climbing_activities', proposal_api_event.AbseilingClimbingActivityViewSet,"abseiling_climbing_activities")
router.register(r'proposal_pre_event_parks', proposal_api_event.ProposalPreEventsParksViewSet,"proposal_pre_event_parks")
router.register(r'proposal_events_trails', proposal_api_event.ProposalEventsTrailsViewSet,"proposal_events_trails")
