                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <button
                                        ...
                                        @click.prevent="generateByAccount()"
                                    >
                                        Generate Report By Accounts
                                    </button>
                                </div>
                                <div class="col-sm-6 clearfix">
                                    <button
                                        class="btn btn-primary pull-left"
                                        @click.prevent="generateFlatReport()"
                                    >
                                        Generate Report Flat
                                    </button>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="checkbox">
                                            <label
                                                ><input
                                                    v-model="oracle_override"
                                                    type="checkbox"
                                                    value=""
                                                />Override closed period
                                                check</label
                                            >
                                        </div>
                                    </div>
...
export default {
    ...
    watch: {
        region: function () {
            ...
            vm.district = '';
            if (vm.region) {
                vm.selected_region = vm.regions.find(
                    (r) => r.code == vm.region
                );
            } else {
                vm.selected_region = {
    ...
    methods: {
        ...
        runOracleJob() {
            ...
            if (vm.oracle_form.valid()) {
                ...
                vm.$http
                    .get(
                        '/api/oracle_job?date=' + data + '&override=' + override
                    )
                    .then(
                        () => {
                            swal({
