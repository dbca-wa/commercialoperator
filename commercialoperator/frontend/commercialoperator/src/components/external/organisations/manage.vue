<template>
    <div id="userInfo" :class="classCompute">
        <div class="col-sm-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        >
                            <div class="col-sm-12 row mb-3">
                                ...
                                Use the Organisation User pin codes if you want
                                    ...
                                    <div class="col-sm-6 row">
                                        ...
                                        >
                                            <label
                                                ...
                                                class="col-sm-6 control-label"
                                            >
                                                Organisation Administrator Pin
                                                Code 1:</label
                                            >
                                            <div class="col-sm-6">
                                                <label class="control-label">{{
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group row">
                                        <div class="col-sm-12 top-buffer-s">
                                            ...
                                            the distribution of pin codes. If
                                            you are not sure which pin code to
                                            give to your staff member please
                                            call the Tourism and Concessions
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12 top-buffer-s">
                                            ...
                                            authorised to
                                            apply/cancel/surrender/pay fees on
                                    ...
                                    <div class="form-group row mb-3">
                                        <div class="col-sm-12 top-buffer-s">
                                            ...
                                            organisation. The Department cannot
                                            manage this list of accounts.
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <AddContact v-if="org" ref="add_contact" :org_id="org.id" />
        </div>
    </div>
</template>
