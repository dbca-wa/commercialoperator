                    ...
                    <div class="form-horizontal col-sm-12">
                       <div class="form-group">
                           <div class="row">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <FileField :proposal_id="proposal.id" isRepeatable="true" name="event_other_details" :id="'proposal'+proposal.id" :readonly="!canEditActivities"></FileField>
                                </div>                                
                            </div>
                       </div> 
                    </div>
                ...
                <div class="" >                        
                    <div class="form-horizontal col-sm-12 ">
                        <div class="form-group">
                           <div class="row">
                                <div class="col-sm-12">
                                    <label>It is a requirement of all commercial operations licence holders to sign a deed poll to release and indemnify the State of Western Australia. Please note: electronic or digital signatures cannot be accepted where witnessing is required. </label>
