...
export default {
    ...
    data: function () {
        ...
        return {
            ...
            parks_url: helpers.add_endpoint_json(
                ...
                vm.$route.params.proposal_id + '/events_parks'
            ),
            trails_url: helpers.add_endpoint_json(
                api_endpoints.proposals,
                vm.$route.params.proposal_id + '/events_trails'
            ),
            abseiling_climbing_url: helpers.add_endpoint_json(
                api_endpoints.proposals,
                vm.$route.params.proposal_id + '/abseiling_climbing_activities'
            ),
            trail_options: [],
    ...
    watch: {
        selected_trail_ids: function () {
            ...
            vm.selected_trails = [];
            for (let i = 0; i < vm.selected_trail_ids.length; i++) {
                const data = vm.get_selected_trail_data(
