                    ...
                    <div class="form-horizontal col-sm-12 borderDecoration">                        
                        <div class="">
                            ...
                            <div class="row" v-if="proposal.event_activity.pdswa_location">
                                ...
                                <div class="col-sm-6">
                                    <FileField :proposal_id="proposal.id" isRepeatable="true" name="event_activity_pdswa_location" :id="'proposal'+proposal.id" :readonly="!canEditActivities" ref="event_activity_pdswa_file"></FileField>
                                </div>                                
                            </div>
                            <div class="row">&nbsp;</div> 
                        </div> 
