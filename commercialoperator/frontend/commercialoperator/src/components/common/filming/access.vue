                    ...
                    <div class="">
                        ...
                        <div class="col-sm-12 borderDecoration">
                            <div class="form-group">
                                ...
                                <div
                                    v-if="proposal.filming_access.track_use"
                                    class="row"
                                >
                                    <div class="col-sm-6">
                                        <label
                                ...
                                <div
                                    v-if="proposal.filming_access.off_road"
                                    class="row"
                                >
                                    <div class="col-sm-6">
                                        <label
                                ...
                                <div
                                    v-if="proposal.filming_access.road_closure"
                                    class="row"
                                >
                                    <div class="col-sm-6">
                                        <label
                                ...
                                <div
                                    v-if="proposal.filming_access.camp_on_land"
                                    class="row"
                                >
                                    <div class="col-sm-6">
                                        <label
                                ...
                                <div
                                    v-if="proposal.filming_access.staff_to_film"
                                    class="row"
                                >
                                    <div class="col-sm-6">
                                        <label
    ...
    data: function () {
        ...
        return {
            ...
            parks_url: helpers.add_endpoint_json(
                ...
                vm.$route.params.proposal_id + '/filming_parks'
            ),
            global_settings: [],
        };
    },
