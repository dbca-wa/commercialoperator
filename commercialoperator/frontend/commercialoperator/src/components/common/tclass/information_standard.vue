...
<div>
    <div class="row">
                <fieldset class="scheduler-border">
                    <legend class="scheduler-border">{{information_standard.information_standard_type_value}}</legend>
                    <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <FileField :proposal_id="proposal_id" :isRepeatable="false" :name="'information_standard'+information_standard.information_standard_type" :id="'information_standard'+information_standard.information_standard_type+proposal_id" :readonly="!canEditActivities" ref="information_standard_file"></FileField>
                            </div>
                        </div>
                        <div  class="row">
                            <div class="col-sm-3">
