...
export default {
    ...
    methods:{
        ...
        sendData:function(){
            ...
            if (vm.processing_status != 'With Approver'){
                vm.$http.post(helpers.add_endpoint_json(api_endpoints.district_proposals,vm.district_proposal_id+'/proposed_decline'),JSON.stringify(decline),{
                        emulateJSON:true,
                    }).then((response)=>{
                ...
                vm.$http.post(helpers.add_endpoint_json(api_endpoints.district_proposals,vm.district_proposal_id+'/final_decline'),JSON.stringify(decline),{
                        emulateJSON:true,
                    }).then((response)=>{
                        vm.decliningProposal = false;
                        vm.close();
